# -*- coding: utf-8 -*-
"""Fine_tune_BERT_sentence_simlarity.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uZp0StA7Gst4HbB6iJUJtBo2d__kCMok
...
df_train = pd.read_csv('/content/drive/MyDrive/df_Final_train.csv')
df_val = pd.read_csv('/content/drive/MyDrive/df_final_val.csv')
df_test = pd.read_csv('/content/drive/MyDrive/df_Final_test.csv')
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        sent1 = str(self.data.loc[index, 'Argument'])
        sent2 = str(self.data.loc[index, 'Keypoints'])
...
def train_bert(net, criterion, opti, lr, lr_scheduler, train_loader, val_loader, epochs, iters_to_accumulate):
    ...
    # Saving the model
    path_to_model='/content/drive/MyDrive/bert.pt'
...
def test_prediction(net, device, dataloader, with_labels=True, result_file='/content/drive/MyDrive/output_AlBERT.txt'):
    """
...
path_to_output_file = '/content/drive/MyDrive/output_bert.txt'
...
path_to_output_file = '/content/drive/MyDrive/output_bert.txt'   # path to the file with prediction probabilities
...
y_test = list(labels_test)
pred = list(preds_test)
